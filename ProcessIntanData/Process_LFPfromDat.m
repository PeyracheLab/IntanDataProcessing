function Process_LFPfromDat(basepath,varargin)
...
%Modified bby APeyrache for internal use 2019
...
if exist(fxml,'file') %&& ~exist(fsessioninfo,'file')
    par = LoadXml(basename);
    inFs = par.SampleRate;
    nbChan = par.nChannels;
    outFs = par.lfpSampleRate;    
elseif exist(fsessioninfo,'file')
